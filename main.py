...
• 🎯 Easy to use UI""".format(username=user_name)
    ...
    # Create keyboard with support channel button (optional)
    keyboard = []
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if query.data == "check_join":
        # This callback may still be present in old messages; handle gracefully
        await query.answer("Please use the web app to verify membership.", show_alert=True)
